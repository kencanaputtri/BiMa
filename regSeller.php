        ...
        <div class="register-container">
            ...
            <form action="proses_register.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kategoriToko" required>
                </div>
                ...
                <button type="submit" class="btn btn-primary btn-block">Mulai Berjualan</button>
                
                <div class="divider">atau</div>
                
                <button type="button" class="btn btn-outline-secondary btn-block">
                    <img src="/path/to/google-icon.png" alt="Google" style="width: 20px; margin-right: 8px;">
